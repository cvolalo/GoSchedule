...
import static com.projectprototype.lib.WeekViewUtil.*;
...
public class WeekView extends View {
    ...
    private void init() {
        ...
        Rect rect = new Rect();
        mTimeTextPaint.getTextBounds("0", 0, "0".length(), rect);
    ...
    private void initTextTimeWidth() {
        ...
        for (int i = 0; i < 24; i++) {
            ...
            mTimeTextWidth = Math.max(mTimeTextWidth, /*mTimeTextPaint.measureText(time)*/0);
        }
    }
        ...
        if (mDateTimeInterpreter == null) {
            mDateTimeInterpreter = new DateTimeInterpreter() {
                ...
                public String interpretDate(Calendar date) {
                    try {
                        SimpleDateFormat sdf = mDayNameLength == LENGTH_SHORT ? new SimpleDateFormat("EEEEE M/dd/yy", Locale.getDefault()) : new SimpleDateFormat("EEE M/dd/yy", Locale.getDefault());
     ...
     * </p>
     * @param length Supported values are {@link com.projectprototype.lib.WeekView#LENGTH_SHORT} and
     * {@link com.projectprototype.lib.WeekView#LENGTH_LONG}.
     */
    @Deprecated
    ...
    public interface EventLongPressListener {
        /**
         * Similar to {@link com.projectprototype.lib.WeekView.EventClickListener} but with a long press.
         * @param event: event clicked.
         * @param eventRect: view containing the clicked event.
         */
    ...
    public interface EmptyViewLongPressListener {
        /**
         * Similar to {@link com.projectprototype.lib.WeekView.EmptyViewClickListener} but with long press.
